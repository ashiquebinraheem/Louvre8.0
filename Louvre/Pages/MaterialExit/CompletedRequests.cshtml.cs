...
namespace Louvre.Pages
{
    ...
    public class CompletedExitRequestsModel : BasePageModel
    {
        private readonly IDbContext _dbContext;

        public CompletedExitRequestsModel(IDbContext entity)
        {
            _dbContext = entity;
        }
        ...
        //    SearchData.WhereCondition = $@"StatusID={(int)RequestStatus.Completed} and IsIn=0 and RequestedByID={CurrentUserID}";
