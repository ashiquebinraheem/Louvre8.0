...
namespace Louvre.Pages
{
    ...
    public class PendingExitRequestsModel : BasePageModel
    {
        private readonly IDbContext _dbContext;

        public PendingExitRequestsModel(IDbContext entity)
        {
            _dbContext = entity;
        }
        ...
        //    SearchData.WhereCondition = $@"StatusID in ({(int)RequestStatus.Pending},{(int)RequestStatus.Processing},{(int)RequestStatus.Forwarded}) and IsIn=0 and RequestedByID={CurrentUserID}";
