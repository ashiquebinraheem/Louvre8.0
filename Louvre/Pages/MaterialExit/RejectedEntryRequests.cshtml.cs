...
namespace Louvre.Pages
{
    ...
    public class RejectedExitRequestsModel : BasePageModel
    {
        private readonly IDbContext _dbContext;

        public RejectedExitRequestsModel(IDbContext entity)
        {
            _dbContext = entity;
        }
        ...
        public async Task<IActionResult> OnPostSearchAsync()
        {
            ...
            SearchData.WhereCondition = $@"RequestedByID={CurrentUserID} and IsIn=1 and  StatusID={(int)RequestStatus.Rejected}";
