...
namespace Louvre.Pages
{
    ...
    public class AcceptedExitRequestsModel : BasePageModel
    {
        private readonly IDbContext _dbContext;

        public AcceptedExitRequestsModel(IDbContext entity)
        {
            _dbContext = entity;
        }
        ...
        //    SearchData.WhereCondition = $@"StatusID={(int)RequestStatus.Accepted} and IsIn=0 and RequestedByID={CurrentUserID}";
        ...
        LEFT JOIN RequestType T ON R.RequestTypeID = T.RequestTypeID";
            ...
            // Force CurrentUserID to int to block injection
