...
namespace Louvre.Pages.ProjectAsset
{
    ...
    public class RejectedProjectRequestsModel : BasePageModel
    {
        private readonly IDbContext _dbContext;

        public RejectedProjectRequestsModel(IDbContext dbContext)
        {
        ...
        public void OnGetAsync()
        {
            ...
            {
                new SearchByViewModel("RequestNo", "Request No","100px"),
        ...
        public async Task<IActionResult> OnPostSearchAsync()
        {
            ...
            SearchData.WhereCondition = $@"RequestedByID={CurrentUserID} and IsIn=1 and  StatusID={(int)RequestStatus.Rejected} and ISNULL(IsProjectAsset,0)=1";
