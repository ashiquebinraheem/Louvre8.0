...
namespace Louvre.Pages.DailyPass
{
    ...
    public class RejectedDailyPassRequestsAdminModel : BasePageModel
    {
        private readonly IDbContext _dbContext;

        public RejectedDailyPassRequestsAdminModel(IDbContext dbContext)
        {
        ...
        public async Task<IActionResult> OnPostSearchAsync()
        {
            ...
            SearchData.WhereCondition = $@"R.RequestTypeID in(Select RequestTypeID from RequestTypeApprovalStage Where UserTypeID={CurrentUserTypeID}) and IsIn=1 and  StatusID={(int)RequestStatus.Rejected}";
