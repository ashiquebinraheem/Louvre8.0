...
namespace Louvre.Pages
{
    ...
    public class PendingEntryRequestsModel : BasePageModel
    {
        private readonly IDbContext _dbContext;

        public PendingEntryRequestsModel(IDbContext entity)
        {
            _dbContext = entity;
        }
        ...
        //    SearchData.WhereCondition = $@"StatusID in ({(int)RequestStatus.Pending},{(int)RequestStatus.Processing},{(int)RequestStatus.Forwarded}) and IsIn=1 and RequestedByID={CurrentUserID} and ISNULL(IsProjectAsset,0)=0";
        ...
        LEFT JOIN RequestType T ON R.RequestTypeID = T.RequestTypeID";
            ...
            // Safe where condition (force int for CurrentUserID)
        ...
        AND ISNULL(IsProjectAsset,0) = 0";
            ...
            switch (SearchData.SearchColumnName)
            {
                ...
                default:
                    ...
                    SearchData.SearchColumnName = "EmployeeName";
                    break;
            }
