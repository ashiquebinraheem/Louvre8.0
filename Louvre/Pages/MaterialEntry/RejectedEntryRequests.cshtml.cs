...
namespace Louvre.Pages
{
    ...
    public class RejectedEntryRequestsModel : BasePageModel
    {
        private readonly IDbContext _dbContext;

        public RejectedEntryRequestsModel(IDbContext entity)
        {
            _dbContext = entity;
        }
        ...
        public async Task<IActionResult> OnPostSearchAsync()
        {
            ...
            SearchData.WhereCondition = $@"RequestedByID={CurrentUserID} and IsIn=1 and  StatusID={(int)RequestStatus.Rejected} and ISNULL(IsProjectAsset,0)=0";
